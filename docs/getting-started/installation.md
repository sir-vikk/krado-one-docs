...
description: "Detailed installation guide for Krado One using Docker images, PostgreSQL, Kubernetes, and Helm."
---
...
For the 2-minute quick start see [Quick start](./quickstart).
